...
# opens what is passed in as the dictionary_path parameter
...
#make empty list the bobggle board, append a row based on range. Return board
    def make_board(self):
        """Make and return a random boggle board."""

        board = []

# string.ascii_uppercase = ABCDEFGHIJKLMNOPQRSTUVWXYZ. gives random choice of 5 letters, 5 times - there are repeas in any one row
...
# take in board and word. If the word passed in exists within words.txt- ok - If not a valid word - not-on-board. Else- not a word.Return result
